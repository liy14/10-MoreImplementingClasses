...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.hc1 = rg.Point(self.intersection_center.x + self.width/2,self.intersection_center.y - self.thickness/2)
        self.hc2 = rg.Point(self.intersection_center.x - self.width/2,self.intersection_center.y + self.thickness/2)
        self.h_rect = rg.Rectangle(self.hc1, self.hc2)
        self.vc1 = rg.Point(self.intersection_center.x + self.thickness / 2, self.intersection_center.y - self.thickness / 2)
        self.vc2 = rg.Point(self.intersection_center.x - self.thickness / 2, self.intersection_center.y - self.thickness / 2 + self.height)
        self.v_rect = rg.Rectangle(self.vc1, self.vc2)
